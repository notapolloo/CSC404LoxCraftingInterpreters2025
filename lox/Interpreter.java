...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {  
    ...
    Interpreter() {
        globals.define("clock", new LoxCallable() {
            ...
            List<Object> arguments) {
                System.out.println(""+(double)System.currentTimeMillis() / 10000.0+"");
        ...
        */
        globals.define("type", new LoxCallable() { //works
            @Override
            public int arity() { return 1; }//1 argument
        ...
        */
        ...
        globals.define("echo", new LoxCallable() {
            @Override
            public int arity() { return 1; }//1 argument
            ...
            @Override
            public int arity() { return 0; }//1 argument
    ...
    public Void type(Stmt.Print stmt) {
        Object value = evaluate(stmt.expression);
    ...
    //HOW PRINT WORKS
    public String echo(Stmt.Print stmt) {
        Object value = evaluate(stmt.expression);
        System.out.println(stringify(value));
